<TABLE style="width:200mm;height:140mm;margin-left:10mm;margin-top:5mm;table-layout:fixed;">
	...
	<TR>
		...
		<TD rowspan=3 style="width:65mm;vertical-align:top;font-size:14pt;padding-top:-15mm;">
			Заместителю мэра города - <BR>руководителю аппарата<BR><BR>
			<SPAN style="font-size:14pt;font-weight:bold;">Гармашову В.С.</SPAN>
		</TD>
	</TR>
</TABLE>
...
<TR>
	<TD>предоставить доступ к следующим информационным ресурсам, содержащим конфиденциальную информацию:</TD>
</TR>
</TABLE>
...
<TABLE style="width:175mm;table-layout:fixed;font-size:12pt;border-collapse:collapse;margin-left:10mm;border-spacing:0px;">
	<TR>
		...
		<TD style="border:1px solid #000000;text-align:center;padding:3px;width:80mm;font-size:11pt;border-top:none">&nbsp;</TD>
		<TD style="border:1px solid #000000;text-align:center;padding:3px;width:18mm;font-size:11pt;border-left:none;">администри<BR>рование</TD>
		<TD style="border:1px solid #000000;text-align:center;padding:3px;width:18mm;font-size:11pt;border-left:none;">полный доступ</TD>
		<TD style="border:1px solid #000000;text-align:center;padding:3px;width:18mm;font-size:11pt;border-left:none;">изменение</TD>
		<TD style="border:1px solid #000000;text-align:center;padding:3px;width:17mm;font-size:11pt;border-left:none;">чтение</TD>
	</TR>
</TABLE>
