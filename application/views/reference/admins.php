...
<form method="post" action="#" class="form-horizontal">
	...
	<div class="well well-small span12 container-fluid" style="margin-left:0px;margin-bottom:80px;">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" name="login" id="login" class="span3" placeholder="Введите новый логин" value="<?=$user;?>">&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="text" name="description" id="login" class="span7" placeholder="Введите описание" value="<?=$description;?>">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="checkbox inline" style="cursor:pointer;"><input type="checkbox" name="rank" id="rank" style="margin-top:2px;" <?=$adminrank?>> Администратор</label>
			</div>
		</div>
	...
	<tr>
		...
		<th class="col2">Пользователь</th>
		<th class="col3">Куратор работ</th>
		<th class="col3">Ранг</th>
		<th class="col4"></th>
	</tr>
	<?=$admin_list;?>
	</table>
